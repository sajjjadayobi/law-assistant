...
Usage:
    from law_assistant.database import get_session, get_document
    from law_assistant.database.models import Document, Relation
...
from law_assistant.database.models import Base, Document, Relation
from law_assistant.database.queries import (
    get_document,
    get_document_count,
