...
from law_assistant.agent import ConversationManager, LawAgent
from law_assistant.config.settings import Settings, StarterQuestion
from law_assistant.data import get_data_layer
from law_assistant.observability import (
    initialize_feedback_client,
    initialize_tracing,
    shutdown_tracing,
)
from law_assistant.ui.citations import CitationFormatter
from law_assistant.ui.rate_limit import check_and_increment
...
async def handle_feedback(feedback: cl.Feedback) -> None:
    ...
    if span_id:
        try:
            from law_assistant.observability.feedback import get_feedback_client
...
from law_assistant.health import get_health_status, get_readiness  # noqa: E402
